...
HD_PWD='C:/Users/James Kibii/OneDrive/Dokumente/Vivado/Stepper_Motor/Stepper_Motor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stepper_motor_top_pwm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stepper_motor_top_pwm.tcl -notrace
