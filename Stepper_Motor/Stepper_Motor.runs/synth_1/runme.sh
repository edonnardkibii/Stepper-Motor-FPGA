...
HD_PWD='C:/Users/James Kibii/OneDrive/Dokumente/Vivado/Stepper_Motor/Stepper_Motor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stepper_motor_top_pwm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stepper_motor_top_pwm.tcl
