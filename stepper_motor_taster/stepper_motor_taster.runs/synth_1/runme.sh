...
HD_PWD='C:/Users/james/OneDrive/Dokumente/Vivado/SoC_Projects/stepper_motor_taster/stepper_motor_taster.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stepper_motor_taster_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stepper_motor_taster_top.tcl
