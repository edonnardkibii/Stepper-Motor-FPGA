...
HD_PWD='C:/Users/james/OneDrive/Dokumente/Vivado/SoC_Projects/stepper_motor_taster/stepper_motor_taster.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stepper_motor_taster_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stepper_motor_taster_top.tcl -notrace
