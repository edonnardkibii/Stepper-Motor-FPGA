...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../Stepper_Motor.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../Stepper_Motor.srcs/sources_1/bd/system/ipshared/5bb9/hdl/verilog" \
       +incdir+"$ref_dir/../../../../Stepper_Motor.srcs/sources_1/bd/system/ipshared/70fd/hdl" \
       +incdir+"../../../../Stepper_Motor.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../Stepper_Motor.srcs/sources_1/bd/system/ipshared/5bb9/hdl/verilog" \
       +incdir+"../../../../Stepper_Motor.srcs/sources_1/bd/system/ipshared/70fd/hdl" \
