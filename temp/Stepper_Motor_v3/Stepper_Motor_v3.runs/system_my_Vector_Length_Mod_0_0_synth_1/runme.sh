...
HD_PWD='C:/Users/james/OneDrive/Dokumente/Vivado/SoC_Projects/Stepper_Motor_v3/Stepper_Motor_v3.runs/system_my_Vector_Length_Mod_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_my_Vector_Length_Mod_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_my_Vector_Length_Mod_0_0.tcl
