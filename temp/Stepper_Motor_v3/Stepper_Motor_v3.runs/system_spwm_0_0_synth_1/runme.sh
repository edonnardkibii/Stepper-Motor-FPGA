...
HD_PWD='C:/Users/James Kibii/OneDrive/Dokumente/Vivado/SoC_Projects/Stepper_Motor_v3/Stepper_Motor_v3.runs/system_spwm_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_spwm_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_spwm_0_0.tcl
