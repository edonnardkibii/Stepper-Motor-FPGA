...
HD_PWD='C:/Users/james/OneDrive/Dokumente/Vivado/SoC_Projects/Stepper_Motor_v3/Stepper_Motor_v3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stepper_motor_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stepper_motor_top.tcl
