...
HD_PWD='C:/Users/james/OneDrive/Dokumente/Vivado/SoC_Projects/Stepper_Motor_Dig/Stepper_Motor_Dig.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stepper_motor_dig_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stepper_motor_dig_top.tcl -notrace
