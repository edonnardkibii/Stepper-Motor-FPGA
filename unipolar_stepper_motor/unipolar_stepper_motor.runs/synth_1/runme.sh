...
HD_PWD='C:/Users/james/OneDrive/Dokumente/Vivado/SoC_Projects/unipolar_stepper_motor/unipolar_stepper_motor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log unipolar_stepper_motor_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source unipolar_stepper_motor_top.tcl
