...
HD_PWD='C:/Users/james/OneDrive/Dokumente/Vivado/SoC_Projects/unipolar_stepper_motor/unipolar_stepper_motor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log unipolar_stepper_motor_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source unipolar_stepper_motor_top.tcl -notrace
