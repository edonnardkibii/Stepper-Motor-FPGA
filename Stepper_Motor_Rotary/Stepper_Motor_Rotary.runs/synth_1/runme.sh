...
HD_PWD='C:/Users/james/OneDrive/Dokumente/Vivado/SoC_Projects/Stepper_Motor_Rotary/Stepper_Motor_Rotary.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stepper_motor_rotary_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stepper_motor_rotary_top.tcl
