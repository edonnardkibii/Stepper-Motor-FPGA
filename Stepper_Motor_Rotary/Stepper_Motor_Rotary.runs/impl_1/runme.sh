...
HD_PWD='C:/Users/james/OneDrive/Dokumente/Vivado/SoC_Projects/Stepper_Motor_Rotary/Stepper_Motor_Rotary.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stepper_motor_rotary_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stepper_motor_rotary_top.tcl -notrace
