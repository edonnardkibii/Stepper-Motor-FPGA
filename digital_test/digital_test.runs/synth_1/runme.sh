...
HD_PWD='C:/Users/james/OneDrive/Dokumente/Vivado/SoC_Projects/digital_test/digital_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log digital_test_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source digital_test_top.tcl
