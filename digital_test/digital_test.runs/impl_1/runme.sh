...
HD_PWD='C:/Users/james/OneDrive/Dokumente/Vivado/SoC_Projects/digital_test/digital_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log digital_test_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source digital_test_top.tcl -notrace
