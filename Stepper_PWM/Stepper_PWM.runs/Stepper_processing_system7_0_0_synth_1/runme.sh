...
HD_PWD='C:/Users/kibii/OneDrive/Studienkolleg/Vivado/Stepper_PWM/Stepper_PWM.runs/Stepper_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Stepper_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Stepper_processing_system7_0_0.tcl
